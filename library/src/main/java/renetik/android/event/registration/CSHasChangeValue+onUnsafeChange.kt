...
fun <Argument1, Argument2, Argument3, Argument4, Argument5, Argument6,
    ...
    registrations.register(first.onChange { newValue ->
        val values = synchronized<Any, CSSixtuple<Argument1, Argument2,
                Argument3, Argument4, Argument5, Argument6>>(lock) {
            value1 = newValue
...
@JvmName("onUnsafeChangeWithSafeBoth")
fun <Argument1, Argument2, Item1, Item2> Pair<Item1, Item2>.onUnsafeChange(
    onUnsafeChange: (Argument1, Argument2) -> Unit,
): CSRegistration
    ...
    registrations.register(first.onUnsafeChange { newValue ->
        val values = synchronized<Any, Pair<Argument1, Argument2>>(lock) {
            value1 = newValue
            value1 to value2
        }
...
fun <Argument1, Argument2, Argument3, Argument4, Argument5,
    ...
    registrations.register(first.onChange { newValue ->
        val values = synchronized<Any, CSQuintuple<Argument1, Argument2,
                Argument3, Argument4, Argument5>>(lock) {
            value1 = newValue
            CSQuintuple(value1, value2, value3, value4, value5)
        }
        fireChange(values)
...
fun <Argument1, Argument2, Argument3, Argument4, Argument5, Argument6,
    ...
    var value6 = sixth.value
    fun fireChange(
        values: CSSixtuple<Argument1, Argument2, Argument3,
                Argument4, Argument5, Argument6>
    ) {
        if (registrations.isActive) onUnsafeChange(
            values.first, values.second, values.third,
            values.fourth, values.fifth, values.sixth)
    }
    registrations.register(first.onChange { newValue ->
        val values =
            synchronized<Any, CSSixtuple<Argument1, Argument2, Argument3, Argument4, Argument5, Argument6>>(
